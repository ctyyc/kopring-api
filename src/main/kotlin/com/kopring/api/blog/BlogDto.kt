...
import com.kopring.api.common.annotation.ValidEnum
...
data class BlogDto(
        ...
        @JsonProperty("sort")
        @Schema(description = "정렬순서", nullable = false, example = "ACCURACY")
        ...
        @JsonProperty("page")
        @Schema(description = "페이지 번호", nullable = false, example = "1")
        private val _page: Int?,

        @field:NotNull(message = "size parameter required")
        @JsonProperty("size")
        @Schema(description = "페이지 크기", nullable = false, example = "10")
